    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-[#18181B]">{t('adm3_77652296cd')}</h1>
            <p className="text-[#71717A]">{count}{t('adm3_3_02a20f4f46')}</p>
          </div>
        </div>
...
const COMPARE_ROWS = [
  ...
  { key: 'saleDate', label: 'Auction date' },
  { 
    key: 'confidence', 
    label: 'Confidence',
    ...
    render: (v) => {
      ...
      return (
        <span className={`px-2 py-1 rounded-lg text-sm font-medium ${colors[v] || ''}`}>
          {v === 'good_deal' ? t('adm3_c4c363b59f') : v === 'fair_deal' ? t('adm3_54b053602c') : t('adm3_c455c4d3b6')}
        </span>
      );
    },
  },
