        ...
        actions={(
          <>
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 h-11 px-4 rounded-xl bg-[#18181B] hover:bg-[#27272A] text-white text-[12.5px] font-semibold disabled:opacity-50 focus:outline-none focus-visible:ring-4 focus-visible:ring-black/10"
            >
              <RefreshCw className={`w-3.5 h-3.5 ${loading ? 'animate-spin' : ''}`} />
              <span>{lang === 'uk' ? t('adm2_b6bf91f845') : 'Refresh'}</span>
            </button>
          </>
        )}
      />
