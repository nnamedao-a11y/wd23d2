    ...
    >
      ...
      <div className="space-y-5 sm:space-y-6">
        <ControlPageHeader
          ...
          action={
            <div className="flex items-center gap-1.5 px-3 h-10 bg-[#EEF2FF] rounded-lg">
              <Timer size={15} className="text-[#4F46E5]" weight="duotone" />
              <span className="text-xs sm:text-sm font-medium text-[#4F46E5] whitespace-nowrap">
