  ...
  return (
    <div className="space-y-5">
      ...
      <Block
        ...
        footer={(
          <span>
            <strong>{t('recommendedLabel')}</strong> {t('heroBackgroundFormat')}
          </span>
        )}
      >
        <div className="grid grid-cols-1 md:grid-cols-[1fr_320px] gap-5 items-start">
          ...
          <div className="space-y-3">
            ...
            <Field label={t('orPasteImageUrl')} hint={t('adm_external_url_or_relative_path_leave_empty_to_use_t')}>
              <input
                type="text"
            ...
            <div className="text-[11.5px] text-[#71717A] leading-relaxed">
              <strong>{t('tipsColon')}</strong> compress to keep under 1 MB when possible (TinyPNG / Squoosh).
