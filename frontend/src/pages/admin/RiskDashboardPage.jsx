...
const RiskDashboardPage = () => {
  ...
  return (
    <div className="space-y-4 sm:space-y-5" data-testid="risk-dashboard">
      <AdminPageHeader
        icon={Shield}
        title={t('riskDashboardTitle') || t('adm2_42cdb12fba') || 'Risk Dashboard'}
        subtitle={t('riskDashboardSubtitle') || t('adm2_9d77ef153f')}
        testId="risk-header"
        actions={(
          <>
            <span
            ...
            >
              ...
              <span className="hidden sm:inline">{lang === 'uk' ? t('adm2_662670c22d') : 'Daily check'}</span>
            </button>
            <button
              type="button"
              onClick={fetchData}
