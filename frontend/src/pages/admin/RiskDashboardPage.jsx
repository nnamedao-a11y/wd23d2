...
const RiskDashboardPage = () => {
  ...
  return (
    <div className="space-y-6" data-testid="risk-dashboard">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-3">
            ...
            {t('riskDashboardTitle') || t('adm2_42cdb12fba')}
          </h1>
        ...
        <div className="flex items-center gap-4">
          {/* Connection Status */}
          <div className={`flex items-center gap-2 px-3 py-1.5 rounded-md ${autoRefresh ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'}`}>
          ...
          >
            ...
            {lang === 'uk' ? t('adm2_662670c22d') : 'Run Daily Check'}
          </button>
      ...
      <div className={`${riskStyle.bg} border ${riskStyle.border} rounded-lg p-4 sm:p-5 mb-6`}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className={`text-2xl font-bold ${riskStyle.text} uppercase`}>
                {lang === 'uk' ? t('adm2_cdb840f566') : 'Risk Level'}: {overallRiskLevel.toUpperCase()}
              </h2>
              <p className="text-gray-500 mt-1">
          ...
          <div className="text-right">
            ...
            <p className="text-gray-500 text-sm">{lang === 'uk' ? t('adm2_b71f1aa544') : 'Total Score'}</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <RiskCard
          ...
          color="orange"
          description={lang === 'uk' ? t('adm2_ac26095e45') : 'Anomalous activity'}
        />
        <RiskCard
          icon={AlertCircle}
          ...
          color="red"
          description={lang === 'uk' ? t('adm2_0c9e3624d6') : 'Overdue payments'}
        />
        <RiskCard
          icon={AlertTriangle}
          ...
          color="amber"
          description={lang === 'uk' ? t('adm2_d4febced76') : 'Need attention'}
        />
        <RiskCard
          icon={XCircle}
          ...
          color="purple"
          description={lang === 'uk' ? t('adm2_d22824a42b') : 'Not working'}
        />
      </div>
        ...
        <div className="bg-white rounded-lg p-4 sm:p-5 border border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
            ...
            {criticalAlerts.length > 0 && (
              <span className="bg-red-500 text-white text-xs px-2 py-0.5 rounded-md ml-2">
  ...
  return (
    <div className={`bg-white rounded-lg p-4 sm:p-5 border border-gray-200`}>
      <div className="flex items-center justify-between">
        ...
        <div className={`w-12 h-12 ${iconColors[color]} rounded-lg flex items-center justify-center`}>
...
const RiskModal = ({ risk, onClose, lang }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50" onClick={onClose}>
      <div className="bg-white rounded-lg p-5 max-w-lg w-full mx-4 border border-gray-200 shadow-xl" onClick={e => e.stopPropagation()}>
        ...
        {/* Risk Score */}
        <div className={`${riskStyle.bg} border ${riskStyle.border} rounded-lg p-4 mb-6`}>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <RiskIcon className={`w-8 h-8 ${riskStyle.text}`} />
              <div>
        ...
        <div className="mb-6">
          ...
          <div className="space-y-2">
            {risk.factors && risk.factors.length > 0 ? risk.factors.map((factor, idx) => (
              ...
              <p className="text-gray-500 text-sm">{t('adm_no_factors_detected')}</p>
            )}
          </div>
        </div>
