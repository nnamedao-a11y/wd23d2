              ...
              <div className="px-5 sm:px-6 py-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <button
                    type="button"
                    onClick={saveService}
                    className="h-11 w-full rounded-xl bg-[#635BFF] text-white font-medium hover:bg-[#564FE6] transition-colors inline-flex items-center justify-center gap-2 focus:outline-none focus-visible:ring-4 focus-visible:ring-black/10"
