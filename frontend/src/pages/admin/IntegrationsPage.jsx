    ...
    <div className="space-y-5 sm:space-y-6">
      <div className="flex items-start justify-between gap-3 mb-2">
        <div className="min-w-0">
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">{t('integrationsTitle')}</h1>
          <p className="text-xs sm:text-sm text-gray-500 mt-1.5">{t('integrationsSubtitle')}</p>
        </div>
        <button
          onClick={loadData}
          className="inline-flex items-center justify-center gap-1.5 h-10 px-3 sm:px-4 bg-gray-100 rounded-lg hover:bg-gray-200 text-xs sm:text-sm whitespace-nowrap flex-shrink-0"
        >
                  ...
                  <div className="px-4 py-3 border-b border-gray-200 bg-white">
                    <div className="grid grid-cols-2 sm:flex sm:flex-wrap items-stretch gap-2">
                      <button
                        ...
                        className="inline-flex items-center justify-center gap-1.5 h-9 px-3 rounded-lg border border-gray-200 bg-white text-xs sm:text-sm text-gray-700 hover:bg-gray-50 disabled:opacity-50 whitespace-nowrap"
                      >
                        {testing === provider ? (
