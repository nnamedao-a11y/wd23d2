    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div className="flex gap-2 flex-shrink-0">
          <Link to="/team/managers" className="px-3 sm:px-4 py-2 bg-[#18181B] text-white rounded-xl text-xs sm:text-sm font-medium hover:bg-[#27272A] transition-colors whitespace-nowrap" data-testid="dash-managers-link">
            {t('managers')}
          </Link>
          <Link to="/team/reassignments" className="px-3 sm:px-4 py-2 border border-[#E4E4E7] text-[#18181B] rounded-xl text-xs sm:text-sm font-medium hover:bg-[#F4F4F5] transition-colors whitespace-nowrap" data-testid="dash-reassignments-link">
            {t('reassignments')}
          </Link>
        </div>
      </div>
