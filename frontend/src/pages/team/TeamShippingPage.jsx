...
const TeamShippingPage = () => {
  ...
  const handleViewMap = async (shipmentId) => {
    try {
      ...
      toast.error(t('loadError') || t('adm3_a24231caf8'));
    }
  };
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center justify-center gap-1">
                          <button
                            ...
                            title={t('showOnMap') || t('adm3_41ac00f700')}
                          >
                            <MapPin size={16} />
                          </button>
                          <button
        ...
        >
          ...
          >
            <div className="sticky top-0 bg-white border-b border-zinc-200 px-6 py-4 flex items-center justify-between">
              <div>
                <h3 className="font-semibold text-lg text-zinc-900">{t('shipmentTracking') || t('adm3_bb353366a9')}</h3>
