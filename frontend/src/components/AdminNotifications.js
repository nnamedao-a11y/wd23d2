    ...
    >
        ...
        <div className="flex items-center gap-2 mb-1">
          ...
          {notification.priority && notification.priority !== 'medium' && (
            <span className={`px-1.5 py-0.5 rounded text-[10px] font-semibold ${priorityColors[notification.priority]}`}>
              {notification.priority === 'urgent' ? t('i18n_urgent_1d9ae0') : notification.priority === 'high' ? t('i18n_important_74b4d9') : 'LOW'}
            </span>
          )}
          {!notification.isRead && (
      ...
      {!notification.isRead && (
        <button
          ...
          title={t('i18n_mark_as_read_fed392')}
        >
          <Check size={16} />
        </button>
      )}
          ...
          >
              ...
              {loading ? (
                ...
                <div className="text-center py-12 px-4">
                  ...
                  <p className="text-sm text-[#71717A]">
                    {filter === 'unread' ? t('i18n_no_unread_notifications_b6e2f6') : t('i18n_no_notifications_41b3cc')}
                  </p>
                </div>
              ) : (
            ...
            {notifications.length > 0 && (
              <div className="border-t border-[#E4E4E7] p-3">
                ...
                >
                  {t('i18n_view_all_notifications_8586c1')}
                  <CaretRight size={16} />
                </button>
              </div>
            )}
