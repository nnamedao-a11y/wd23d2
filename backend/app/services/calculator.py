...
async def calculator_calculate(data: Dict[str, Any] = Body(...)):
    ...
    breakdown = [
        ...
        {"key": "usaInland",         "label": "Delivery By Truck Across The USA",  "value": r(usa_inland),      "visibility": "client",     "category": "cost"},
        {"key": "ocean",             "label": "Delivery By Ship",                  "value": r(ocean),           "visibility": "client",     "category": "cost"},
        ...
        {"key": "euDelivery",        "label": "Delivery To Bulgaria",              "value": r(eu_delivery),     "visibility": "client",     "category": "cost"},
        # ─ Final fees
